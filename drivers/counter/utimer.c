...
#define UT_STOP_SRC		0xc
#define UT_CLEAR_SRC		0x14
...
#define UT_GLB_CNTR_START		0x0
#define UT_GLB_CNTR_STOP		0x4
#define UT_GLB_CNTR_CLEAR		0x8
#define UT_GLB_CNTR_RUNNING		0xc
#define UT_GLB_DRIVER_OEN		0x10
#define UT_GLB_DRIVER_CLK_ENABLE	0x20
