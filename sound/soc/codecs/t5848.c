 ...
 *
 * Copyright (c) 2025 Alif Semiconductors
...
#ifdef CONFIG_OF
static const struct of_device_id t5848_of_match[] = {
	{ .compatible = "invensense,t5848", },
	{ /* sentinel*/ }
};
MODULE_DEVICE_TABLE(of, t5848_of_match);
#endif

static struct platform_driver t5848_driver = {
	.driver = {
		.name = "t5848-codec",
		.of_match_table = of_match_ptr(t5848_of_match),
	},
	.probe = t5848_probe,
};
